  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden">
      ...
      {/* max-w-5xl mx-auto text-center */}
        ...
        <Link href="/">
          <h1 className="text-[#DD5046] text-2xl font-normal mb-1 tracking-wide">
            Robin Gottschalk
          </h1>
        ...
        <div className="max-w-5xl mx-auto text-center mt">
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap my-10">
            <span className="text-white/90 font-[family-name:var(--font-inter)] text-lg font-medium">
              For
            </span>
            <button className="px-4 py-2 border border-white/40 text-white/90 font-[family-name:var(--font-inter)] text-lg font-medium hover:bg-white/10 transition-colors">
              founders
            </button>
            <span className="text-white/90 font-[family-name:var(--font-inter)] text-lg font-medium">
              ,
          ...
          {/* Main Heading */}
          <h2 className="font-[family-name:var(--font-garamond)] text-white text-5xl md:text-7xl lg:text-[5.5rem] leading-tight mb-8 font-normal tracking-wide">
          ...
          {/* Subheading */}
          <p className="text-[#9EC0D1] text-xl leading-relaxed mb-12 max-w-3xl mx-auto font-light">
