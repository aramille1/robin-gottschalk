      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="mb-4 text-left">
            <span className="text-gray-400 text-lg">What if...?</span>
        ...
        <div className="mb-16">
          ...
          >
            {doubts.map((doubt) => (
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-4xl p-6 h-40 flex items-center justify-center relative backdrop-blur-sm">
